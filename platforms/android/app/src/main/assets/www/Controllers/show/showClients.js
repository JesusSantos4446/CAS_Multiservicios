...
async function fetchClients() {
  try {
    ...
    clients = data.filter(client => client.Role === 1);

    // Mostrar la primera página y crear los controles de paginación
        ...
        <td class="px-4 py-3">
          <div class="flex items-center text-sm">
            <div class="relative w-8 h-8 mr-3 rounded-full md:block">
              <img class="object-cover w-full h-full rounded-full" src="${viewImg_route + client.Email + ".jpg"}" alt="" loading="lazy" />
